...
const KeyFeatures = ({ title, description, children,shapeUrl }) => {
    return (
        <div className="w-56 h-56 rounded-md shadow-md shadow-themeOrange p-1 bg-[#E5E5E5]">
            <div className="w-full h-full flex justify-center flex-col gap-1 p-2">
                ...
                <span className="font-bold text-lg tracking-tight w-full">{title || "Title"}</span>
                <p className="text-sm tracking-wide font-semibold break-words">
                    {description ||
